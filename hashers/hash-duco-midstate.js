// Updated DUCO-S1 algorithm found in the web miner starting from v3.2
// Implements midstate caching, DOUBLING the hashrate compared to the old algorithm
...
(function e(t, r) {
    ...
    return function(e) {
        ...
        var c = function(e, t) {
            ...
            for (var i = (t >> 2) + 1; i < e.length; i++) {
                e[i] = 0
            }
        };
        var h = function(e, t, r) {
            e[t >> 2] |= 128 << 24 - (t % 4 << 3);
            e[((t >> 2) + 2 & ~15) + 14] = r / (1 << 29) | 0;
            e[((t >> 2) + 2 & ~15) + 15] = r << 3
        };
        var p = function(e, t) {
            ...
            a.setInt32(0, r[0], false);
            a.setInt32(4, r[1], false);
            a.setInt32(8, r[2], false);
            a.setInt32(12, r[3], false);
            a.setInt32(16, r[4], false);
            return n
        };
        var l = function() {
            function e(t) {
            ...
            e.prototype._initState = function e(t, r) {
                this._offset = 0;
                var n = new Int32Array(t,r + 320,5);
                n[0] = 1732584193;
                n[1] = -271733879;
                n[2] = -1732584194;
                n[3] = 271733878;
            ...
            e.prototype._padChunk = function e(t, r) {
                var n = u(t);
                var a = new Int32Array(this._heap,0,n >> 2);
                c(a, t);
                h(a, t, r);
                return n
            }
            ...
            e.prototype.rawDigest = function e(t) {
                var r = t.byteLength || t.length || t.size || 0;
                ...
                this._coreCall(t, n, r - n, r, true);
                return p(this._heap, this._padMaxChunkLen)
            }
            ;
            ...
            e.prototype.append = function e(t) {
                ...
                var a = this._offset % this._maxChunkLen;
                var i = void 0;
                this._offset += n;
                while (r < n) {
                    i = Math.min(n - r, this._maxChunkLen - a);
                    this._write(t, r, i, a);
                    a += i;
                    r += i;
                    if (a === this._maxChunkLen) {
            ...
            e.prototype.rawEnd = function e() {
                var t = this._offset;
                var r = t % this._maxChunkLen;
                var n = this._padChunk(r, t);
    ...
    , function(e, t) {
        ...
        e.exports.isDedicatedWorkerScope = function(e) {
            ...
            var r = "SharedWorkerGlobalScope"in e && e instanceof e.SharedWorkerGlobalScope;
            var n = "ServiceWorkerGlobalScope"in e && e instanceof e.ServiceWorkerGlobalScope;
            return t && !r && !n
        }
    }
    , function(e, t, r) {
        e.exports = function() {
            ...
            self.onmessage = function(r) {
                ...
                if (!o && !i)
                    return;
                var f = r.data.blockSize || 4 * 1024 * 1024;
                var u = new e(f);
                u.resetState();
                var c = function(e, t) {
                    if (!e) {
    ...
    , function(e, t, r) {
        ...
        var o = r(2);
        var s = r(1)
          , f = s.isDedicatedWorkerScope;
        var u = typeof self !== "undefined" && f(self);
        a.disableWorkerBehaviour = u ? o() : function() {}
        ;
    ...
    , function(e, t, r) {
        ...
        function s(e, t, n) {
            ...
            s[n] = [];
            var f = t.toString();
            var u = f.match(/^function\s?\(\w+,\s*\w+,\s*(\w+)\)/);
            if (!u)
                return s;
            var c = u[1];
            var h = new RegExp("(\\\\n|\\W)" + o(c) + i,"g");
            var p;
            while (p = h.exec(f)) {
                if (p[3] === "dll-reference")
                    continue;
                s[n].push(p[3])
            }
            h = new RegExp("\\(" + o(c) + '\\("(dll-reference\\s(' + a + '))"\\)\\)' + i,"g");
            while (p = h.exec(f)) {
                if (!e[p[2]]) {
                    s[n].push(p[1]);
                    e[p[2]] = r(p[1]).m
        ...
        e.exports = function(e, t) {
            ...
            Object.keys(i).filter(function(e) {
                ...
                o = o + "var " + e + " = (" + n.toString().replace("ENTRY_MODULE", JSON.stringify(t)) + ")({" + i[e].map(function(t) {
            ...
            var f = window.URL || window.webkitURL || window.mozURL || window.msURL;
            var c = f.createObjectURL(s);
        ...
        e.exports = function e(t, r, n) {
            ...
            function i(e, t) {
                ...
                for (r = 0; (r | 0) < (e | 0); r = r + 64 | 0) {
                    ...
                    p = h;
                    v = l;
                    for (n = 0; (n | 0) < 64; n = n + 4 | 0) {
                        y = a[r + n >> 2] | 0;
                        d = ((i << 5 | i >>> 27) + (s & u | ~s & h) | 0) + ((y + l | 0) + 1518500249 | 0) | 0;
                        l = h;
                        h = u;
                        u = s << 30 | s >>> 2;
                        s = i;
                    ...
                    for (n = e + 64 | 0; (n | 0) < (e + 80 | 0); n = n + 4 | 0) {
                        y = (a[n - 12 >> 2] ^ a[n - 32 >> 2] ^ a[n - 56 >> 2] ^ a[n - 64 >> 2]) << 1 | (a[n - 12 >> 2] ^ a[n - 32 >> 2] ^ a[n - 56 >> 2] ^ a[n - 64 >> 2]) >>> 31;
                        d = ((i << 5 | i >>> 27) + (s & u | ~s & h) | 0) + ((y + l | 0) + 1518500249 | 0) | 0;
                        l = h;
                        h = u;
                        u = s << 30 | s >>> 2;
                    ...
                    for (n = e + 80 | 0; (n | 0) < (e + 160 | 0); n = n + 4 | 0) {
                        y = (a[n - 12 >> 2] ^ a[n - 32 >> 2] ^ a[n - 56 >> 2] ^ a[n - 64 >> 2]) << 1 | (a[n - 12 >> 2] ^ a[n - 32 >> 2] ^ a[n - 56 >> 2] ^ a[n - 64 >> 2]) >>> 31;
                        d = ((i << 5 | i >>> 27) + (s ^ u ^ h) | 0) + ((y + l | 0) + 1859775393 | 0) | 0;
                        l = h;
                        h = u;
                        u = s << 30 | s >>> 2;
                        s = i;
                    ...
                    for (n = e + 160 | 0; (n | 0) < (e + 240 | 0); n = n + 4 | 0) {
                        y = (a[n - 12 >> 2] ^ a[n - 32 >> 2] ^ a[n - 56 >> 2] ^ a[n - 64 >> 2]) << 1 | (a[n - 12 >> 2] ^ a[n - 32 >> 2] ^ a[n - 56 >> 2] ^ a[n - 64 >> 2]) >>> 31;
                        d = ((i << 5 | i >>> 27) + (s & u | s & h | u & h) | 0) + ((y + l | 0) - 1894007588 | 0) | 0;
                        l = h;
                        h = u;
                        u = s << 30 | s >>> 2;
                        s = i;
                    ...
                    for (n = e + 240 | 0; (n | 0) < (e + 320 | 0); n = n + 4 | 0) {
                        y = (a[n - 12 >> 2] ^ a[n - 32 >> 2] ^ a[n - 56 >> 2] ^ a[n - 64 >> 2]) << 1 | (a[n - 12 >> 2] ^ a[n - 32 >> 2] ^ a[n - 56 >> 2] ^ a[n - 64 >> 2]) >>> 31;
                        d = ((i << 5 | i >>> 27) + (s ^ u ^ h) | 0) + ((y + l | 0) - 899497514 | 0) | 0;
                        l = h;
                        h = u;
                        u = s << 30 | s >>> 2;
                        s = i;
    ...
    , function(e, t) {
        ...
        var a = function(e, t, r, n, a, i) {
            ...
            case 1:
                t[i + 1 - (s << 1) | 0] = e.charCodeAt(n + 2);
            case 2:
                t[i + 2 - (s << 1) | 0] = e.charCodeAt(n + 1);
            case 3:
                t[i + 3 - (s << 1) | 0] = e.charCodeAt(n)
            }
            if (a < f + (4 - s)) {
                return
            }
            ...
            switch (f) {
            case 3:
                t[i + u + 1 | 0] = e.charCodeAt(n + u + 2);
            case 2:
                t[i + u + 2 | 0] = e.charCodeAt(n + u + 1);
            case 1:
        ...
        var o = function(e, t, r, a, i, o) {
            var s = void 0
              ...
              , u = (i + f) % 4
              , c = i - u;
            var h = new Uint8Array(n.readAsArrayBuffer(e.slice(a, a + i)));
            switch (f) {
            case 0:
                t[o] = h[3];
            case 1:
